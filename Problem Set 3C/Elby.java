public class Elby {
    ...
    public String getResponse(String statement) {
        ...
        || findKeyword(statement,"horse", 0) >= 0) {
            response = "Tell me more about your pets.";
        } else if (findKeyword(statement,"no", 0) >= 0) {
            response = "Why so negative?";
        } else if (findKeyword(statement,"sad", 0) >= 0
        || findKeyword(statement,"upset", 0) >= 0) {
            response = "What excatly made you feel this way?";
        } else if (findKeyword(statement,"school", 0) >= 0
        || findKeyword(statement,"work", 0) >= 0) {
            response = "Is that stressful?";
        } else if (findKeyword(statement,"Laila", 0) >= 0
        || findKeyword(statement,"Wilcox", 0) >= 0) {
            response = "She seems like a great person.";
    ...
    private String getRandomResponse() {
        ...
        if (whichResponse == 0) {
            ...
            response = "Have you also thought like this?";
        } else if (whichResponse == 6) {
            response = "Why do you bring this topic up?";
        }else if (whichResponse == 7) {
            response = "Has that happened before?";
        }
        return response;
    }
